            ...
            if (data.length == 0) {
                ...
                data.forEach(agent => {
                    ...
                    if (data.profileImg == null) {
                        profileImg = '/avatar/agent-avatar.jpeg';
                    }
                    ...
                    row = `
                        <tr>
                            ...
                            <td>
                            <img src="${profileImg}" alt="agent" style="max-width: 50px; max-height: 50px; border-radius: 50%;"> 
                            ${agent.firstName} ${agent.middleName} ${agent.lastName}</td>
                            <td>${agent.occupation}</td>
                            <td>${agent.email} sqrs</td>
                            <td>
                                <abbr title="view"><i class="bi bi-eye-fill px-1" data-bs-toggle="modal" data-bs-target="#moreInfo${agent.id}"></i></abbr>
                                <abbr title="update"><i class="bi bi-pencil-fill px-1" data-bs-toggle="modal" data-bs-target="#update${agent.id}"></i></abbr>
                                <abbr title="delete"><i class="bi bi-trash-fill px-1 delete-btn" data-item-id="${agent.id}"></i></abbr>
                            </td>
                        </tr>
                    `;
