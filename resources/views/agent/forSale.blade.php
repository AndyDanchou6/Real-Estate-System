            ...
            <div class="card-header">
                <div class="container">
                    <div class="row mb-0" style="align-items: center;">
                        <h5 class="col-md-5">For Sale</h5>
                        <form class="col-sm-8 col-md-5 mb-3" id="search-forSale">
                        ...
                        <div class="col-sm-4 col-md-2 mb-3">
                            <div class="container">
                                <div class="row">
                                    <select class="form-select" name="filter" id="forSale-filter">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function fetchAll() {
            try {
                var apiUrl = '/api/properties/forSale/all';
                var parameters = {
                    method: 'GET',
                    headers: {
            ...
            if (data.length == 0) {
                ...
                data.forEach(property => {
                    ...
                    <tr>
                        ...
                        <td>
                            <i class="bi bi-eye-fill px-1" data-bs-toggle="modal" data-bs-target="#moreInfo${property.id}"></i>
                            <i class="bi bi-pencil-fill px-1" data-bs-toggle="modal" data-bs-target="#update${property.id}"></i>
                            <i class="bi bi-trash-fill px-1 delete-btn" data-item-id="${property.id}"></i>
                        </td>
                    </tr>
                `;
        ...
        var filter = document.querySelector('#forSale-filter');

        filter.addEventListener('change', async function() {

            var apiUrl = '/api/properties/forSale/' + filter.value;
            var parameters = {
                method: 'GET',
                headers: {
        ...
        var searchForSale = document.querySelector('#search-forSale');

        searchForSale.addEventListener('submit', async function(event) {

            event.preventDefault();

            var searchInput = searchForSale.querySelector('input').value;
            var apiUrl = '/api/properties/forSale/search/' + searchInput;
            var parameters = {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
