            ...
            <div class="card-header">
                <div class="container">
                    <div class="row mb-0" style="align-items: center;">
                        <h5 class="col-md-5">For Rent</h5>
                        <form class="col-sm-8 col-md-5 mb-3" id="search-forRent">
                        ...
                        <div class="col-sm-4 col-md-2 mb-3">
                            <div class="container">
                                <div class="row">
                                    <select class="form-select" name="filter" id="forRent-filter">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function fetchAll() {
            try {
                var apiUrl = '/api/properties/forRent/all';
                var parameters = {
                    method: 'GET',
                    headers: {
        ...
        var filter = document.querySelector('#forRent-filter');

        filter.addEventListener('change', async function() {

            var apiUrl = '/api/properties/forRent/' + filter.value;
            var parameters = {
                method: 'GET',
                headers: {
        ...
        var searchForRent = document.querySelector('#search-forRent');

        searchForRent.addEventListener('submit', async function(event) {

            event.preventDefault();

            var searchInput = searchForRent.querySelector('input').value;
            var apiUrl = '/api/properties/forRent/search/' + searchInput;
            var parameters = {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
