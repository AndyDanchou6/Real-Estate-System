    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="container-xl">
                <div class="row" id="commercial-container">
...
<script>
    function displayProperty(data) {
        ...
        var commercialContainer = document.querySelector('#commercial-container');
        var text = `
            <div class="col-md-6 col-lg-4 col-xxl-3">
        ...
        commercialContainer.innerHTML += text;
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function fetchAllProperties() {
            try {
                var response = await fetch('/api/commercial');
        ...
        async function searchCommercial() {
            try {
                const searchBar = document.querySelector('#search-commercial');
                ...
                searchBar.addEventListener('submit', async function(event) {
                    ...
                    var apiUrl = '/api/properties/search/commercial/' + searchInput;
